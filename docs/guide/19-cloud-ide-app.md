...
::: tip
CLI 的使用方式见 [CLI 安装与登录](./13-cli-installation.md)，IDE 插件见 [在 VS Code 中使用 Codex](./15-ide-vscode.md)，桌面 App 的使用见 [Codex 桌面 App 下载与安装](./01-app-installation.md)。
:::
